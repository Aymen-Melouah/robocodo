...
namespace Game.Controller.Operation
{
    ...
    public class TurnLeftOperation : BotOperation
    {
        ...
        public override bool IsValid()
        {
            ...
            BotController.Direction newDirection = (BotController.Direction)(((int)botController.currentDirection + 3) % 4);
            ...
            Debug.Log("TurnLeft - Platform exists in new direction: " + platformExists);
            if (!platformExists) {
                Debug.Log("TurnLeft - Will play warning sound");
            }
        ...
        public override IEnumerator Run()
        {
            ...
            {
                Debug.Log("TurnLeft - Playing warning sound now");
